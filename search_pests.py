"""
search_pests.py - Retrieval-only semantic search for the pests knowledge base.
No LLM synthesis — returns top-k matching chunks with scores and sources.
Usage:
    python search_pests.py
    python search_pests.py "your query here"
"""
import sys
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        print("Pests RAG - Retrieval Mode. Type 'exit' to quit.\n")
        while True:
            try:
                q = input("Query: ").strip()
